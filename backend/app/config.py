...
USE_LIVE_SEC_COMPANYFACTS = _env_bool("USE_LIVE_SEC_COMPANYFACTS", USE_LIVE_COMPANY_DATA)
SEC_COMPANYFACTS_CACHE_DIR = Path(os.getenv("SEC_COMPANYFACTS_CACHE_DIR", "backend/raw_store/cache/sec_companyfacts"))
SEC_COMPANYFACTS_CACHE_TTL_DAYS = float(os.getenv("SEC_COMPANYFACTS_CACHE_TTL_DAYS", "7") or "7")
SEC_COMPANYFACTS_NETWORK_TIMEOUT_SECONDS = float(os.getenv("SEC_COMPANYFACTS_NETWORK_TIMEOUT_SECONDS", "10") or "10")
...
USE_LIVE_USPTO_PATENTS_DATA = _env_bool("USE_LIVE_USPTO_PATENTS_DATA", False)
USPTO_PATENTS_CACHE_TTL_DAYS = int(os.getenv("USPTO_PATENTS_CACHE_TTL_DAYS", "30") or "30")
