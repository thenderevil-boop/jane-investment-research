...
def _cache_dir() -> Path:
    path = config.MARKET_DATA_CACHE_DIR / "fmp_financials"
...
def save_fmp_financials_snapshot(ticker: str, payload: dict[str, Any], fetched_at: datetime | None = None) -> dict[str, Any]:
...
def load_cached_fmp_financials(ticker: str, ttl_days: int, now: datetime | None = None) -> dict[str, Any] | None:
