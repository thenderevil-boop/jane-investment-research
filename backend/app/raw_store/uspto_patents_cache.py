...
def _cache_dir() -> Path:
    path = config.MARKET_DATA_CACHE_DIR / "uspto_patents"
...
def save_uspto_patents_snapshot(ticker: str, payload: dict[str, Any], fetched_at: datetime | None = None) -> dict[str, Any]:
...
def load_cached_uspto_patents(ticker: str, ttl_days: int, now: datetime | None = None) -> dict[str, Any] | None:
