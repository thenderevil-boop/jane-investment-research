...
def _cache_dir() -> Path:
    path = config.MARKET_DATA_CACHE_DIR / "openbb_options"
...
def save_openbb_options_snapshot(ticker: str, payload: dict[str, Any], fetched_at: datetime | None = None) -> dict[str, Any]:
...
def load_cached_openbb_options(ticker: str, ttl_days: int, now: datetime | None = None) -> dict[str, Any] | None:
